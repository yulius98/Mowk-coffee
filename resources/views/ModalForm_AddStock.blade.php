            ...
            <div class="mt-3">
                ...
                <div class="bg-[rgb(236,222,210)] rounded-xl shadow-lg overflow-hidden transform p-6 max-w-md">
                    ...
                    @if (is_object($edit_produk))
                        ...
                        <form id="Add_stock" class="space-y-4" action="/add_stock" method="post" enctype="multipart/form-data">    
                            @csrf
                            ...
                            <div>
                                <label class="block text-sm font-bold text-black">Add Stock</label>
