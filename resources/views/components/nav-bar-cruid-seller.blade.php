<nav class="fixed w-full top-0 z-50 bg-[#331C09] transition-all duration-300 ">
        ...
        <div class="flex items-center">  
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <a href="/#" class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-[#522E0E] hover:text-white">Order Product</a>  
              <a href="/#" class="rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-[#522E0E] hover:text-white">Event</a>
            </div> 
          </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      ...
      <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
        <a href="#" class="block rounded-md px-3 py-2 text-sm font-medium text-white hover:bg-[#522E0E] hover:text-white">Order Status</a>
      </div>
