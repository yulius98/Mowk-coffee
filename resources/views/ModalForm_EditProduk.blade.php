<x-layout-cruid-seller>
        ...
        <div class="mt-3">
            ...
            @if (is_object($edit_produk))
                <!--<form id="EditProductForm" class="space-y-4" action="/CRUIDSeller" method="post"> -->
                <form id="EditProductForm" class="space-y-4" method="post">    
                    @csrf
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            <div class="text-center">
                                ...
                                @if ($edit_produk->image)
                                    <img src="{{ asset('path/to/images/' . $edit_produk->image) }}" alt="Existing Image" style="width: 5rem; height: 5rem;" class="mt-4" />
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" id="produk_unggulan" name="produk_unggulan" value="1" 
                               class="rounded border-gray-300 font-bold text-black shadow-sm focus:border-blue-500 focus:ring-blue-500" {{ $edit_produk->produk_unggulan ? 'checked' : '' }}>
                    ...
                    <div class="flex justify-end space-x-3 mt-5">
                        ...
                        <button class="rounded-md bg-[#A14C36] px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-[#723322]" onclick="window.location.href='/edit_produk/{{$edit_produk->id}}'" >
                                Save
                        </button>
